  ...
  return (
    <div className="w-full h-24">
      <section className="w-full flex flex-col items-center justify-center">
        <h1 className="font-oswald text-4xl text-center lg:text-6xl mt-32">
          Helping Families Reunite with Their Loved Ones
        </h1>
        <p className="text-2xl text-center lg:text-3xl text-gray-700 font-oswald opacity-80 my-6 mb-12">
      ...
      <section className="w-full gap-6 flex flex-col items-center justify-center my-6">
        <h1 className="text-4xl mt-32 font-oswald">How It Works</h1>
      ...
      <section className="w-full gap-6 flex flex-col items-center justify-center my-6">
        <h1 className="text-4xl mt-32">Success Stories</h1>
      ...
      <section className="w-full gap-6 flex flex-col items-center justify-center my-6 mb-24 px-4 lg:p-0">
        <h1 className="text-4xl mt-32 font-bold">Join Our Mission</h1>
        ...
        <button
          ...
          className="px-6 py-3 bg-[#634aff] text-white font-bold rounded-xl text-lg hover:bg-[#4f3cbf] transition-all duration-200"
        >
          📢 Share Now
        </button>
      </section>

      <footer className="w-full p-4 flex items-center justify-center bg-gray-100">
        <p className="text-sm text-gray-600">
          © 2025 <b>|</b> Privacy Policy <b>|</b> Terms of Service <b>|</b>{" "}
          Contact Us
        </p>
      </footer>
    </div>
...
const StepBox = ({ step, image, title, description }: BoxProps) => {
  return (
    <span className="w-full lg:w-[30%] min-h-64 flex flex-col items-start justify-center py-4 px-6 bg-gray-100 gap-1 rounded-3xl">
      ...
      <span className="text-lg text-gray-600 opacity-60">{description}</span>
    </span>
  );
};
...
const SuccessStoriesBox = ({ image, title, description }: BoxProps) => {
  return (
    <span className="w-full lg:w-[45%] min-h-56 flex flex-col items-start justify-center py-4 px-6 bg-gray-100 gap-1 rounded-3xl">
      <span className="w-8 aspect-square bg-gray-200 rounded-full flex items-center justify-center mb-4 p-2">
        <img
          src={`../icons/${image === "" ? "heart" : image}.svg`}
          alt="works"
