...
const ReportPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-12 p-6 bg-white rounded-lg overflow-auto">
      <span className="text-gray-600 text-sm mb-4 font-tinos">
        <Link to="/">Home</Link> {" > "}
        <Link to="/reportpage">Report Missing Person</Link>
      </span>

      <h2 className="text-2xl font-semibold mb-2">Report a Missing Person</h2>
      ...
      <div className="w-full flex flex-col items-start justify-center py-4 px-6 bg-gray-100 gap-2 rounded-3xl">
        {image ? (
          <img
            src={image}
            alt="Uploaded"
        ...
        <span className="text-lg text-black font-bold">Upload Photo</span>
        <span className="text-lg text-gray-600 opacity-60">
      ...
      <div className="w-full flex flex-col mt-6">
        ...
        <div className="mt-6">
          <label className="block font-medium text-gray-800 font-tinos">
            Full Name
          </label>
          <input
            type="text"
      ...
      <div className="w-full flex flex-col mt-12">
        <span className="text-lg text-black font-bold">Location Details</span>
      ...
      {isSubmitted && (
        <div className="fixed inset-0 flex items-center justify-center bg-[#00000045]">
          <div className="w-[30%] bg-white p-6 rounded-xl shadow-lg text-center">
